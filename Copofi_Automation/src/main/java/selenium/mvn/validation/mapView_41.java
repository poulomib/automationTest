...
public class mapView_41 {

	public WebDriver driver;

	public mapView_41(WebDriver driver) {
	...
	public void savePropertyAsFavourites() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a/i")));
		Thread.sleep(3000);
	...
	public void checkAddedPropertyInMyAccount(String propertyName, String allProperties) {
		...
		Reporter.log("\n Property added to Favourites is : " + propertyName);
